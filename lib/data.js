...
export const sidebarItems = [
  ...
  {
    icon: <MapPin size={20} className="stroke-green-500" />,
    label: "Locations",
    href: "/locations",
  },

  {
    icon: <Receipt size={20} className="stroke-yellow-500" />,
    label: "POS Invoices",
    href: "/pos",
  },
  {
    icon: <Settings size={20} className="stroke-yellow-500" />,
    label: "Settings",
    href: "/settings",
  },
];
...
export const filters = [
  ...
  { name: "Home & Lifestyles", value: "home" },
  { name: "Men Fashion", value: "men" },
  { name: "Women fashion", value: "woman" },
];
